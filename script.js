...
const GRADE_TOPICS = {
    ...
    '2': [
        ...
        { value: 'mult_2_5_10', text: '✖️ Kleines 1x1 (2er, 5er, 10er)' },
        { value: 'mult_all', text: '✖️ Kleines 1x1 (Gemischt)' },
        ...
        { value: 'time_analog_set', text: '🕰️ Uhrzeit einzeichnen (Analog)' },
    ...
    '3': [
        ...
        { value: 'mult_advanced', text: '✖️ Erweitertes 1x1 (bis 20)' },
        ...
        { value: 'time_analog_set_complex', text: '🕰️ Uhrzeit einzeichnen (Digital -> Analog)' },
        { value: 'rechendreiecke_100', text: '🔺 Rechendreiecke (bis 100)' },
        { value: 'zahlenhaus_100', text: '🏠 Zahlenhaus (bis 100)' }
    ],
    '4': [
        { value: 'add_written', text: '✍️ Schriftliche Addition (bis 1 Mio)' },
        { value: 'sub_written', text: '✍️ Schriftliche Subtraktion (bis 1 Mio)' },
        { value: 'mult_large', text: '✍️ Schriftliche Multiplikation' },
        { value: 'div_long', text: '✍️ Schriftliche Division' },
    ...
    '5': [
        ...
        { value: 'mult_10_100', text: '✖️ Malnehmen mit 10/100/1000' },
        { value: 'units', text: '⚖️ Einheiten umrechnen (m, kg, s)' },
    ],
    '6': [
